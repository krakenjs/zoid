...
import typeof { destroy, destroyComponents, destroyAll, postRobot as PostRobotType } from './component';
...
export { create, destroy, destroyComponents, destroyAll, postRobot } from './component';
...
export type Zoid = {|
    ...
    postRobot : typeof PostRobotType
|};
