...
/***/ function(module, exports, __webpack_require__) {
	...
	var _child = __webpack_require__(/*! ./child */ 41);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _client = __webpack_require__(/*! beaver-logger/client */ 31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _logger = __webpack_require__(/*! ./logger */ 32);
	...
	var _builders = __webpack_require__(/*! ./builders */ 36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _es6PromiseMin = __webpack_require__(/*! es6-promise-min */ 34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! ./~/process/browser.js */ 35), (function() { return this; }())))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _performance = __webpack_require__(/*! ./performance */ 39);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _window = __webpack_require__(/*! ../window */ 48);

	var _lib = __webpack_require__(/*! ../../lib */ 43);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dom = __webpack_require__(/*! ./dom */ 44);
	...
	var _fn = __webpack_require__(/*! ./fn */ 45);
	...
	var _promise = __webpack_require__(/*! ./promise */ 47);
	...
	var _util = __webpack_require__(/*! ./util */ 46);
	    ...
	    _createClass(ParentComponent, [{
	        ...
	        */
	        ...
	        value: function render(element, context) {
	            ...
	            return _promise.SyncPromise.resolve().then(function () {
	                ...
	                context = context || _this3.getRenderContext(element);
	                ...
	                _this3.loadUrl(_this3.buildUrl());
	                _this3.runTimeout();
	        ...
	        */
	        ...
	        value: function renderToParent(element, context) {
	            ...
	            return _promise.SyncPromise.resolve().then(function () {
	                ...
	                context = context || _this4.getRenderContext(element);
	                ...
	                _this4.childWindowName = (0, _window.buildChildWindowName)({
	                    id: _this4.id,
	                    parent: window.name,
	                    sibling: true,
	        ...
	        */
	        ...
	        value: function hijackButton(element) {
	            ...
	            (0, _lib.hijackButton)(element, function (event, targetElement) {
	                ...
	                _this6.renderHijack(targetElement, context);
	            });
	        ...
	        */
	        ...
	        value: function renderHijack(el) {
	            ...
	            return _promise.SyncPromise.resolve().then(function () {
	                ...
	                el.target = _this7.childWindowName;
	        ...
	        */
	        ...
	        value: function createParentTemplate() {
	            ...
	            this.registerForCleanup(function () {
	                document.body.removeChild(_this10.parentTemplate);
	                delete _this10.parentTemplate;
	            });
	        }
	...
	*/
	...
	var RENDER_DRIVERS = exports.RENDER_DRIVERS = (_RENDER_DRIVERS = {}, _defineProperty(_RENDER_DRIVERS, _constants.CONTEXT_TYPES.IFRAME, {
	    ...
	    open: function open() {
	        ...
	        this.open(element, _constants.CONTEXT_TYPES.IFRAME);
