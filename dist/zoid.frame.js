        ...
        "./src/index.js": function(module, __webpack_exports__, __webpack_require__) {
            ...
            var parent_ParentComponent = (_applyDecoratedDescriptor((_class = function(_BaseComponent) {
                ...
                ParentComponent.prototype.buildChildWindowName = function() {
                    var _ref6$renderTo = (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}).renderTo, renderTo = void 0 === _ref6$renderTo ? window : _ref6$renderTo, sameDomain = Object(cross_domain_utils_src.t)(renderTo), uid = Object(lib.R)(), tag = this.component.tag, sProps = Object(lib.K)(this.getPropsForChild()), componentParent = this.getComponentParentRef(renderTo), renderParent = this.getRenderParentRef(renderTo), props = sameDomain || this.component.unsafeRenderTo ? {
